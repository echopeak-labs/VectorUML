...
export const UMLInterfaceNode = memo(({ data }: NodeProps) => {
  ...
  return (
    <div className="rounded-lg border-2 border-uml-interface bg-card shadow-lg min-w-[240px]">
      ...
      <Handle type="source" position={Position.Top} id="top-source" className="w-3 h-3 !bg-uml-interface hover:!bg-uml-interface/80" />
      <Handle type="target" position={Position.Top} id="top-target" className="w-3 h-3 !bg-uml-interface hover:!bg-uml-interface/80" />
      
      <Handle type="source" position={Position.Left} id="left-source" className="w-3 h-3 !bg-uml-interface hover:!bg-uml-interface/80" />
      <Handle type="target" position={Position.Left} id="left-target" className="w-3 h-3 !bg-uml-interface hover:!bg-uml-interface/80" />
      
      <Handle type="source" position={Position.Right} id="right-source" className="w-3 h-3 !bg-uml-interface hover:!bg-uml-interface/80" />
      <Handle type="target" position={Position.Right} id="right-target" className="w-3 h-3 !bg-uml-interface hover:!bg-uml-interface/80" />
      
      <Handle type="source" position={Position.Bottom} id="bottom-source" className="w-3 h-3 !bg-uml-interface hover:!bg-uml-interface/80" />
      <Handle type="target" position={Position.Bottom} id="bottom-target" className="w-3 h-3 !bg-uml-interface hover:!bg-uml-interface/80" />
